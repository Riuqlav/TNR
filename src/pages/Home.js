  ...
  const ContentTable = useMemo(
    () => [
      ...
      },
      {
        ...
        title: "Ranks",
        content:
          "We are proud to have some of our projects ranked among the top web applications in the world. Our team has won several awards for our work, and we are constantly striving to improve our skills and create even better software. We believe that our success is due to our commitment to quality and our passion for what we do.",
        img: NFT3,
        link: "/ranks",
      },
      {
      ...
      },
      {
        ...
        title: "Battle Scene",
        content:
          "A striking representation of a Renaissance battle, this painting captures the chaos and bravery of the time. The artist's skill is evident in the intricate detailing of the soldiers and the dynamic portrayal of action.",
        img: NFT5,
        link: "",
      },
      {
        ...
        content:
          "This Renaissance painting beautifully depicts the heavenly ascension with serene and ethereal imagery. The intricate detailing of the celestial beings showcases the artist's skill and devotion.",
        img: NFT6,
        link: "",
      },
      {
        ...
        content:
          "This still life painting features a hauntingly beautiful skull. The artist has brought a raw and morbid beauty to the forefront, emphasizing the transient nature of life.",
        img: NFT7,
        link: "",
      },
      {
        ...
        content:
          "This baroque painting beautifully depicts the interior of a grand church. The artist's use of light and shadow brings depth to the image, and the intricate details highlight the architectural beauty of the era.",
        img: NFT8,
        link: "",
      },
      {
        ...
        content:
          "Another beautiful representation of the heavens from the Renaissance era, this painting embodies the spiritual aspiration and religious devotion of the time, with celestial beings painted with fine detailing.",
        img: NFT9,
        link: "",
      },
    ],
