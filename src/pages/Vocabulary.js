    ...
    <div className="container mx-auto px-4 md:px-12">
      <div className="flex flex-wrap justify-center">
        {ContentTable.map((post, i) => (
          <div
            className="m-10 max-w-full flex flex-col md:flex-row items-center transform transition duration-500 ease-in-out hover:scale-103"
            key={i}
          >
            <div
              className={` about-image-${post.id} my-8 md:my-20`}
            ...
            <div
              className={`about-content-${post.id}`}
              data-aos-duration="1000"
              data-aos-delay="0"
            >
